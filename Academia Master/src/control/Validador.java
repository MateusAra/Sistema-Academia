...
public class Validador {
    ...
    private static boolean isInvalidCnpjDigits(String cnpj) {
    ...
    private static char calculateDigitCnpj(String cnpj, int position) {
        int sm = 0;
        int peso = 2;
        int num;
    ...
    private static boolean isInvalidCnpjFormat(String cnpj) {
        return cnpj.length() != 14;
    }

    private static boolean isValidCnpj(String cnpj) {
        if (isInvalidCnpjFormat(cnpj) || isInvalidCnpjDigits(cnpj)) {
            return false;
        }

        try {
            char dig13 = calculateDigitCnpj(cnpj, 12);
            char dig14 = calculateDigitCnpj(cnpj, 13);
    ...
    private static char calculateDigitCpf(String cpf, int position) {
        int sm = 0;
        int peso = position + 1;
        int num;
    ...
    private static boolean isInvalidCpfDigits(String cpf) {
    ...
    private static boolean isInvalidCpfFormat(String cpf) {
        return cpf.length() != 11;
    }

    private static boolean isValidCpf(String cpf) {
        if (isInvalidCpfFormat(cpf) || isInvalidCpfDigits(cpf)) {
            return false;
        }

        try {
            char dig10 = calculateDigitCpf(cpf, 9);
            char dig11 = calculateDigitCpf(cpf, 10);
